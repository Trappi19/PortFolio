...
const dictionary = {
  en: {
    ...
    "projects.manage": "Manage in dashboard",
    "skills.title": "Skills",
  ...
  fr: {
    ...
    "home.ctaDashboard": "Ouvrir le dashboard",
    ...
    "about.copy2": "Cette V2 est preconfiguree: tu peux remplir rapidement le contenu tout en gardant un rendu premium et anime.",
    "projects.title": "Projets",
    "projects.manage": "Gerer via dashboard",
    ...
    "cv.copy": "Lie tes dernieres versions ici. Garde les deux langues a jour.",
